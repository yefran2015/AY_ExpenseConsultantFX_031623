...
//
     ...
     */
    public static Calendar returnCalendarFromOF2X(String stringDate) {
...
//			the twelve months in Calendar range from 0-11
            ...
            year = Integer.parseInt(stringDate.split("/")[2].substring(0,stringDate.split("/")[2].length()-6));
            month = Integer.parseInt(stringDate.split("/")[0])-1;
            day = Integer.parseInt(stringDate.split("/")[1]);
            hour = 0;
            minute = 0;
            second = 0;
        }
